    ...
    return (
        <div className="container">            
            ...
            <h3 className="about-header">About Mars Survival Index</h3>
                <div className={hidden ? "about-body" : "about-body active-body"} onClick={() => setHidden(!hidden)}>This project was created for pure fun to "show off" my creative thinking🤪. But, 
                ...
                <div className={hidden ? "about-body-details hidden" : "about-body-details"}>
